...
import { redirectUriAllowed } from './clients.js'
...
export function mountRoutes(router, ctx) {
    const { base, clients, appName, ready, logoUrl, ttl, issuerFor, audienceFor, logger } = ctx
    ...
    function resolveClient(params, res) {
        const client = params.client_id && clients.get(params.client_id)
